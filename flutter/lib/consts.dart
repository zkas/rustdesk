...
const kDefaultScrollAmountMultiplier = 10.0;//default is 5.0
const kDefaultScrollDuration = Duration(milliseconds: 10);//default is 50
const kDefaultMouseWheelThrottleDuration = Duration(milliseconds: 10);//default is 50
